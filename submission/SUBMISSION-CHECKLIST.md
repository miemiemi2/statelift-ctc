...
**Integration:** Real Ethereum Sepolia payment, real HeaderAnchor, official Creditcoin prover and native verifier 0x0000000000000000000000000000000000000FD2, RootInbox receipt/root checks, MPT receipt inclusion and GoalFillFactVerifier exact business checks. Four confirmed testnet state-changing paths are linked from `submission/SUBMISSION.md`.
